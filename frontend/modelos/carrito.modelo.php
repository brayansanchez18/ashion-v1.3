...
class ModeloCarrito {
  ...
  /* ------------------------- End of MOSTRAR TARIFAS ------------------------- */
	...
	static public function mdlNuevasCompras($tabla1, $tabla2, $datos) {
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla1 (id_usuario, id_producto, metodo, email, direccion, pais, cantidad, detalle, pago) VALUES (:id_usuario, :id_producto, :metodo, :email, :direccion, :pais, :cantidad, :detalle, :pago)");
