...
class ModeloCategorias {
  ...
  static public function mdlIngresarCategoria($tabla, $datos) {
    ...
    $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(categoria, ruta, estado, oferta, precioOferta, descuentoOferta, finOferta) VALUES (:categoria, :ruta, :estado, :oferta, :precioOferta, :descuentoOferta, :finOferta)");
  ...
  static public function mdlEditarCategoria($tabla, $datos) {
    ...
    $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET categoria = :categoria, ruta = :ruta, estado = :estado, oferta = :oferta, precioOferta = :precioOferta, descuentoOferta = :descuentoOferta, finOferta = :finOferta WHERE id = :id");
